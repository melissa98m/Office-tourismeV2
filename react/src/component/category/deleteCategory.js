    ...
    return(<Box>
            ...
            >
                <Box className="modal-crud modal-crud-category" sx={{bgcolor: 'background.default'}}>
                    <Typography variant="h4" sx={{textAlign: 'center', mb: 4}} id="delete-Category-title">
                        Supprimer une categorie d'article
                      </Typography>
                    <FormControl>
                        <Box>
                            êtes vous sur de vouloir supprimer la categorie : {oneCategory.name_category}?
                        </Box>
