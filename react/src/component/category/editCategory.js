    ...
    let editCategoryForm = async () => {
        try {
            let updatedCategory = {
                ...
                name_category: name_category ? name_category : oneCategory.name_category,
            }
    ...
    return(<Box >
        ...
        >
            <Box className="modal-crud modal-crud-type" sx={{bgcolor: 'background.default'}}>
                <Typography variant="h4" sx={{textAlign: 'center', mb: 4}} id="edit-type-title">Editer une categorie d'article</Typography>
