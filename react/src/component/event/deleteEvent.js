...
function DeleteEvent(props) {
    ...
    return(<Box>
            <Button
                ...
                onClick={ () => {
                    setShowDelete(true)
                    setOneEvent({id: props.deleteValue.id, name_event: props.deleteValue.name_event, date_start: props.deleteValue.date_start, date_end: props.deleteValue.date_end} )
                } }
            >
            ...
            >
                <Box className="modal-crud modal-crud-event" sx={{bgcolor: 'background.default'}}>
                    ...
                    <FormControl>
                        <Box>
                            êtes vous sur de vouloir supprimer l'event : {oneEvent.name_event}?
                        </Box>
                        <Box sx={{ my: 5}}>
